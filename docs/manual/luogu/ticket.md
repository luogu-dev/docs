...
接受对于题目、题单、标签、公开赛等非开发组处理的不涉及具体的题目的学术相关工单
...
- 修改或撤下题解：仅处理用户对某篇具体题解文章的修改或撤下申请。
- 申请全站推荐：【需要奖项认证等级 6 级及以上】仅处理用户对某篇具体专栏文章的推荐申请。仅受理【学习·文化课】与【休闲·娱乐】类别。由管理员判断是否通过。
