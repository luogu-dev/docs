...
* 放宽的各项限制的内容在订阅期结束后予以永久保留，但将会因超过基础限制而无法新建或编辑内容以及增加新的成员。
...
团队主可在 **用户设置-[订单记录](https://www.luogu.com.cn/user/setting/payment)** 找到这笔订单。

### 升级/续期高级团队的订单

**实际付款的用户**可在 **团队设置-高级团队** 找到对应的付款记录，点击【查看详情/开票】，进入页面后按照提示申请发票。
