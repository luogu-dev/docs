...
- **社区贡献：**  
  用户在洛谷中**提交题解**、**举办公开赛并收入洛谷主题库**可以获得加分。如果一段时间不在洛谷做出上述贡献，分数会逐渐降低。
- **比赛情况：**  
...
- **获得成就：**  
  用户在洛谷进行[奖项认证](./award-certify-oi.md)（含[ICPC/CCPC 奖项认证](./award-certify-cpc.md)）后，根据**洛谷认证等级**可以获得对应的分数，等级越高，得分越多。成就分计算以咕值整体更新时的展示状态为准。
