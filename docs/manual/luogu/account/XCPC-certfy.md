...
1. 支持： [目前已支持认证的奖项列表](https://www.luogu.com.cn/offline-prize/supported-events)
...
4. 因客观 ~~[【数据删除】](https://www.zhihu.com/question/460422916)~~ 因素不添加：
...
**第一次修订：管理组在大量上线数据后发现，本规则对区分度较低赛事的评分会存在虚高现象，因此对规则进行了修订，对部分赛事可能影响较大，如有问题欢迎反馈。**
...
对港澳赛站，CCPC Final 等队伍数量较少的赛站（少于 200 队），建议使用 GP20 积分。GP20 积分表如下：
...
（注：$k$ 值越大，则越看重单一比赛的表现，$k$ 值越小，则越看重多场比赛的累计表现。）
...
- 金气球：单场积分 120 分，或总积分 100 分。
- 蓝气球：单场积分 60 分，或总积分 55 分。
- 绿气球：有获奖记录。
...
- ICPC/CCPC 奖项认证后仅支持奖项展示和展示气球，暂不支持计算洛谷认证等级，未来可能会开放，敬请期待。