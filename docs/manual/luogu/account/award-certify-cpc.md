...
洛谷 ICPC/CCPC 奖项认证已上线。目前支持 2019 年以来“绝大部分”区域赛正式参赛选手奖项认证（**获得正式奖牌，不包含荣誉奖**），**不支持打星队和邀请赛**。
...
- 未持有以上证件请直接[人工认证](award-certify-oi.md#manual-certify)。
...
在首次认证后，未来当洛谷奖项数据库中添加新奖项时，会自动追加同校名的奖项，如未自动追加，用户可**自行追加**已认证学校的奖项。
