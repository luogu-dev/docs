...
- 洛谷将通过支付宝人脸核验来核实用户提供的姓名、身份证号码（或港澳台居民居住证号码）与申请者是否一致。不要求用户有支付宝账号。
...
当新奖项导入后（以[当前可认证的比赛](https://www.luogu.com.cn/offline-prize/supported-events#contest-CspJunior)为准），洛谷将自动追加同名同校的新增奖项以及对部分同地域的升学情形进行自动匹配。若未能自动自动更新，您可尝试重新认证。
