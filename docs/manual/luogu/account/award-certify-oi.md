...
洛谷使用的数据以 [OIerDB](https://oier.baoshuo.dev/) 为准。当名单公布后，因报名时的学校名称十分自由，初期会有较多的学校名称修正（多见于 CSP-J/S），故洛谷**不会即时进行同步**，请不要催促。
...
- 洛谷将通过第三方提供的人脸核验服务来核实用户提供的姓名、身份证号码（或港澳台居民居住证号码）与申请者是否一致。
