...
- 负责人：原则上要求 8 级及以上（金色）奖项认证用户作为比赛负责人，但 6～7 级（蓝色）奖项认证用户也可以。
- 出题履历（可选）：如果负责人只有 6～7 级（蓝色）奖项认证，强烈建议包含此项。
...
- 比赛结束后，出题人应及时将除前两题外的官方题解**取消隐藏并提交审核**。前两题的题解通道打开后，前两题的官方题解也应及时被取消隐藏并提交审核。
