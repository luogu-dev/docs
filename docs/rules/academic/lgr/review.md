...
月赛题目的题面需要严格遵守[洛谷主题库题目规范](../problem-standard.md)。
...
- 现强制出题组提供『官方题解』用于在洛谷题解区展示，出题组需要在比赛前准备好官方题解作为隐藏专栏文章。审核员需要负责确保提供的题解符合基本规范并且具有较高质量以帮助用户理解。审核员需要在官方讲评结束后立即将题解取消隐藏并（通过后台）提交至对应题目的题解区。
