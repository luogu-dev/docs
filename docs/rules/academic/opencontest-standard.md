...
- 应当声明比赛的**整体难度**，目的是给参赛者一定的参考，故要求必须真实。
  ...
  - 声明整体难度为 CSP-J 或同等难度的比赛将受到审查，必须满足：涉及的知识点需在 CCF 大纲入门级范围内；**至少一半的题目**难度不超过 **普及-**，所有题目难度不超过 **普及+/提高**。
...
- 若希望比赛 Rated，请在比赛名称前加上 `【申请 Rated】` 后提交公开赛审核。同时由**负责人**联系 E_Space，发送「申请 Rated」的字样并告知比赛链接和 QQ 号。
