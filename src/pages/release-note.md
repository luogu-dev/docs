...
- 翻新提交记录、个人私信、云剪贴板、图床等页面
- 在 Markdown 编辑器中新增粘贴上传图片功能
- 迁移首页前端至新版全局导航框架（此为过渡版本，未来将完整重做）

### 8月

#### 比赛排行榜

重写比赛排行榜接口，优化加载速度并增加新功能。现在已支持在前端搜索特定选手和对单题成绩进行排序。并且能关注特定的选手。

#### 主题商店

翻新主题商店及主题编辑器，开放用户自定义主题使用新主题特性。

### 6月

#### 新版主题

过渡性上线前端新版主题，支持新版前端使用个性主题，并引入新设置项。后续将更新主题编辑器以支持新版主题编辑。

深色模式正在开发中。

#### 题目难度体系

调整洛谷难度体系，新增“提高”这一难度档，并对其他难度档的名称和范围进行调整。

新难度体系如下：

- 普及/提高-（黄题）：取消“提高-”这一层级称谓，统一标注为“普及”。
- 普及+/提高（绿题）：将原有“提高”调整为“提高-”，标签相应更改为“普及+/提高-”。对于这一档中难度过高的试题，会被调整至青题。
- 提高（青题）【新增】：承接原“提高+/省选-”的绝大多数试题，但剔除其中难度显著偏高的题目。 大致对应 CF2000-2400。
- 提高+/省选-（蓝题）：定位于原“提高+/省选-”难度较高的题目，以及原“省选/NOI-”难度中等偏下的试题。 大致对应 CF2300-2700。
- 省选/NOI-（紫题）：涵盖原“省选/NOI-”难度中等偏上的题目，并纳入原“NOI/NOI+/CTSC”难度较低的试题。 大致对应 CF2700-3100。
- NOI/NOI+/CTS（黑题）：保留原“NOI/NOI+/CTSC”中的绝大部分试题，仅将其中难度偏低的部分降低为“省选/NOI-”。由于 CTSC 改名为了 CTS，因此名称做了相应调整。

#### 比赛系统

新增比赛答疑和比赛公告功能，当前只对官方比赛与公开赛提供。

比赛答疑基于洛谷工单系统，用户可针对比赛事项或特定的单题问题提交工单。由比赛的裁判组进行回复。

其他前端调整：

- 比赛编辑页面翻新，适配新比赛功能  
- 从比赛题目列表进入的比赛增加题目跳转功能，可快速跳转至同比赛的其他题目。

#### 前端页面

精简了前端 loader 包，优化页面加载速度。

### 5月

#### 工单系统

新增工单类型：【申请题单加精】用于用户申请精选题单。原《精选题单征集帖》废弃，如果有未审核的题单，请重新发送工单。

- 发送工单门槛要求：奖项认证 ≥6 级，即蓝钩或者蓝气球；
- 精选题单应当满足[洛谷精选题单规范](/rules/academic/training-promotion-standard)的标准。

#### 题单系统

题单系统列表页面更新：题单分类展示，方便用户筛选；官方题单展示样式优化，做题进度展示更清晰。
题单详情页更新：更新新前端，优化页面性能。

### 4 月

#### 安全优化

- 添加 Passkey 支持，用户可以在登录时使用 Passkey 进行一键登录。具体见个人设置-安全设置。
- 改进会话安全机制，锁定时 cookie 将立即失效。
- 敏感信息（用户名、密码、邮箱、手机号等）修改前强制锁定账户，需要解锁才能继续。

### 3 月

#### 比赛

- 增加重现类型，用户可在比赛列表筛选重现赛
- 比赛详情页更新，优化页面显示，支持组队报名

#### 题目

- 题目详情页增加题目来源信息，方便用户查看题目来源。
...
被封禁用户登录后可查看自己的封禁信息，包括封禁时间、封禁原因，并申请解封。
